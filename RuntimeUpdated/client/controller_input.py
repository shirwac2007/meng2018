...
PORT = 10011 # UDP port for messages from controller messages to monitor
...
class ControllerInput(object):
    ...
    def latest_data(self):
        if self.msgQ.qsize() == 0:
            ...
            # print "in controller, msg=", controller_data
    ...
    def listener_thread(self, sock, controllerQ):
        ...
        while True:
            try:
                ...
                if msg is not None:
                    # print "in controller thread:", msg 
    ...
    def send_test_message(self, msg):
       print "controller test message", msg
