...
settling_interval = 4 # seconds between command and measurement
...
class InputInterface(object):
    ...
    def __init__(self):
        ...
        self.angles = [0,step,step*2,step*3,step*4,step*5,0, -step,-step*2,-step*3,-step*4,-step*5 ]  # range of angles (roll, pitch, yaw) to be measured
        self.translations = [0,20,40,60,80,100,0,-20,-40,-60,-80,-100] #range of translation (x,y,z) movements
    ...
    def begin(self, cmd_func, move_func, limits):
        ...
        if self.outfile:
            self.outfile.write("Len1,Len2,Len3,Len4,Len5,Len6,Roll, Pitch,Yaw\n")
    ...
    def process_data(self):
        ...
        if sensor_data and controller_data:
            print "sensor data average", ['%.1f' % elem for elem in sensor_data]
